package com.yuxiu.mydiary.java.util.statue_bar;
...
public class Eyes {
    ...
    public static void setStatusBarLightMode(Activity activity, int color) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            } else //判断是否为小米或魅族手机，如果是则将状态栏文字改为黑色
    ...
    public static void setStatusBarLightMode(Activity activity, Window window, int color) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                //如果是6.0以上将状态栏文字改为黑色，并设置状态栏颜色
    ...
    public static void setStatusBarLightMode1(Activity activity, int color) {
...
//            if (useThemestatusBarColor) {
                activity.getWindow().setStatusBarColor(activity.getResources().getColor(R.color.c_tr0));
